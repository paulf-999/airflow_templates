## Example DAG - How to Trigger Another DAG (using the `TriggerDagRunOperator`)

**Description**:    Example DAG showing how to trigger another Airflow DAG using the `TriggerDagRunOperator`, but also passing input using Airflow Conf parameters.
