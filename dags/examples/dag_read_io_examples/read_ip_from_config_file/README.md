## Example DAG - How to Read Input from (Input) Config

**Description**:    Example DAG showing how to read input from a config (text) file and use this as part of your Airflow orchestration.
